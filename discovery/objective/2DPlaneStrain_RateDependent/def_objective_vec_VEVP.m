function fun_vec = def_objective_vec_VEVP(in,data)
...
if strcmp(in.library.name,'lib_VEVPHardMixLin_v1')
    if ~in.use_mex
        fun_vec = @(theta) objective_vec_VEVPHardMixLin_v1( ...
            ... % (hyper-)parameters
            theta, ...
            in.library.n_Maxwell, ...
            in.q_case, ...
            in.q, ...
            in.lambda_r, ...
            in.lambda_p, ...
        ...
        fun_vec = @(theta) objective_vec_VEVPHardMixLin_v1_mex( ...
            ... % (hyper-)parameters
            theta, ...
            in.library.n_Maxwell, ...
            in.q_case, ...
...
elseif strcmp(in.library.name,'lib_VEVPHardMixLin_v2')
    if ~in.use_mex
        fun_vec = @(theta) objective_vec_VEVPHardMixLin_v2( ...
            ... % (hyper-)parameters
            theta, ...
            in.library.n_Maxwell, ...
            in.q_case, ...
        ...
        fun_vec = @(theta) objective_vec_VEVPHardMixLin_v2_mex( ...
            ... % (hyper-)parameters
            theta, ...
            in.library.n_Maxwell, ...
            in.q_case, ...
