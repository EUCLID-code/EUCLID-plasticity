function material = FYS_SchmidtIshlinsky_HardMix

material.name = 'FYS_SchmidtIshlinsky_HardMix';
...
material.H_isotropic = [30, 0.5, 650];
material.H_kinematic = [150, 900];
...
%% Plastic Properties
a(1+0*6)=1/2*log(3);
a(1+1*6)=-2*atanh(0.5)+16/15;
a(1+2*6)=2*atanh(0.5)-3776/3465;
a(1+3*6)=-2*atanh(0.5)+838192/765765;
a(1+4*6)=2*atanh(0.5)-366873344/334639305;
a(1+5*6)=-2*atanh(0.5)+159708887504/145568097675;
a(1+6*6)=2*atanh(0.5)-4952992040384/4512611027925;
a(1+7*6)=-2*atanh(0.5)+7515540252863728/6845630929362225;
a(1+8*6)=2*atanh(0.5)-15191340853145811968/13835020108241056725;
a(1+9*6)=-2*atanh(0.5)+5636607513440714886928/5132792460157432044975;
a(1+10*6)=2*atanh(0.5)-332586039362974273675712/302834755149288490653525;
...
alpha = pi/6; % angle at which the material shows the maximum yield strength
ii = 3*(0:(length(material.theta)-1));
cc = cos(ii*alpha);
sigma_0 = sum(material.theta.*cc);
calibration_factor = material.sigma_0 / sigma_0; % should be approx. cos(pi/6)
