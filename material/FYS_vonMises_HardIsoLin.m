function material = FYS_vonMises_HardIsoLin

material.name = 'FYS_vonMises_HardIsoLin';
...
material.H_isotropic = [100, 0, 0]; % isotropic hardening modulus (in Neto et al. p. 256, the hardening variable is approx. 0.5*sigma_0)
