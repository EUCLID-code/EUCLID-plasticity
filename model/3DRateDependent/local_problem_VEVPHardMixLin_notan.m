function [sigmaV,alphaV,epsilonVvp,gamma,viscoelastic,converged_local] = local_problem_VEVPHardMixLin_notan(Gi,gi,Ki,ki,Ginf,Kinf,H_iso,H_kin,eta,sigma_0,time_inc,epsilonV,alphaV_prev,epsilonVvp_prev,gamma_prev)
