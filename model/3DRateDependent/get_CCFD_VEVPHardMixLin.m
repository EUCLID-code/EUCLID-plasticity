function CC = get_CCFD_VEVPHardMixLin(Gi,gi,Ki,ki,Ginf,Kinf,H_iso,H_kin,eta,sigma_0,time_inc,epsilonV,alphaV_prev,epsilonVvp_prev,gamma_prev,FD)
% get_CCFD_VEVPHardMixLin computes the consistent tangent modulus using finite differences
% 
