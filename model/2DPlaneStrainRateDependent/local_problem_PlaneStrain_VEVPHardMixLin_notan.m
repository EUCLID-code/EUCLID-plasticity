function [sigmaV,alphaV,epsilonVvp,gamma,viscoelastic,converged_local] = local_problem_PlaneStrain_VEVPHardMixLin_notan(Gi,gi,Ki,ki,Ginf,Kinf,H_iso,H_kin,eta,sigma_0,time_inc,epsilonV_2DPlaneStrain,alphaV_prev,epsilonVvp_prev,gamma_prev)
...
[sigmaV,alphaV,epsilonVvp,gamma,viscoelastic,converged_local] = local_problem_VEVPHardMixLin_notan( ...
    Gi, ...
    gi, ...
    Ki, ...
    ki, ...
