function [f, df_dsigmaV, d2f_d2sigmaV] = get_df_PlaneStress(theta,sigmaV)
% get_f_PlaneStress evaluates the yield function and its derivatives
%
% ## Comments
% 
% _none_
...
%% Yield Function
f = sigma_eq - sigma_0;
df_dsigmaV = dsigma_eq_dsigmaV - dsigma_0_dsigmaV;
d2f_d2sigmaV = d2sigma_eq_d2sigmaV - d2sigma_0_d2sigmaV;
