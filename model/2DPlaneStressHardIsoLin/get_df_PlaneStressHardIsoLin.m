function [f, df_dsigmaV, d2f_d2sigmaV, df_dgamma, d2f_d2gamma, d2f_dsigmaVdgamma] = get_df_PlaneStressHardIsoLin(theta,H_isotropic,sigmaV,gamma)
...
df_dsigmaV = dsigma_eq_dsigmaV - (1 + H_isotropic*gamma)*dsigma_0_dsigmaV;
d2f_d2sigmaV = d2sigma_eq_d2sigmaV - (1 + H_isotropic*gamma)*d2sigma_0_d2sigmaV;
df_dgamma = - H_isotropic*sigma_0;
d2f_d2gamma = 0;
d2f_dsigmaVdgamma = - H_isotropic*dsigma_0_dsigmaV;
