...
% to solve the optimization problem, multiple optimization algorithms may be
% used
...
if strcmp(in.method,'lsqnonlin_lb_parsplit_HardMixVAF')
    ...
    for idx = 2:in.n_guess
        ...
        % random perturbation of the hardening parameters are assumed to be positive
