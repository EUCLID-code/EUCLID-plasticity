function [u,reaction,epsilonVp_GP,YieldSurface] = global_problem_PlaneStress( ...
    ... % algorithm
    n_save_YieldSurface, ...
    n_NR_global, ...
    tol_NR_global, ...
            ...
            for idx_ele = 1:n_element
                ...
                for idx_Gauss_x = 1:n_Gauss_per_dim
                    for idx_Gauss_y = 1:n_Gauss_per_dim
                        ...
                        [sigmaV,CC,epsilonVp,elastic,converged_local] = local_problem_PlaneStress(n_NR_local,tol_NR_local,CPlaneStress,SPlaneStress,theta,epsilonV,epsilonVp_prev);
                        if ~elastic
